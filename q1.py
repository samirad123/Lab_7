...
checkbutton_java = Checkbutton(root, text="Java", bg="#e3e3e3", onvalue=1, offvalue=0)
checkbutton_java.place(x=230,y=330)

checkbutton_python = Checkbutton(root, text="Python", bg="#e3e3e3", onvalue=1, offvalue=0)
