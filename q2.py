...
def checkError():
    ...
    if (day_of_birth.get() == "" or month_of_birth.get() == ""
            or year_of_birth.get() == "" or given_day.get() == ""
...
def CalculateAge():
    ...
    if value == -1:
        ...
        result_day.insert(0,str(calculated_day))
        result_month.insert(0,str(calculated_month))
        result_year.insert(0,str(calculated_year))
...
#RESUULTANT
Result = Button(root,text = "Resultant Age",command = CalculateAge)
